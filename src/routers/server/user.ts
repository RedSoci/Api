...
export const PATH_ROUTER = "/users"
...
export async function newUser(req:postRequest,res:Response<any>){
...
export async function getUsers(req:getRequest,res:Response<any[]>){
...
export async function getUser(req:GetRequestById,res:Response<any>){
...
export async function updateUser(req:GetRequestById<userAttrs>,res:Response<any>) {
...
export async function deleteUser(req:GetRequestById,res){
    var id =req.params.userId
...
export function checkUserId(req:GetRequestById,res,next:NextFunction){
